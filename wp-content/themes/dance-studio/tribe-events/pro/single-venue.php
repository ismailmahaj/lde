	...
	<div class="cmsmasters_events_venue_header clearfix">
			...
			<div class="tribe-events-event-meta">
				...
				<div class="venue-address">
					...
					<address class="tribe-events-address">
						<span class="location">
							<?php echo dance_studio_return_content($full_address); ?>
						</span>
					</address>
					<?php endif; ?>
					...
					<?php if ( $telephone ): ?>
						<span class="tel">
							<?php echo dance_studio_return_content($telephone); ?>
						</span>
					<?php endif; ?>

					<?php if ( $website_link ): ?>
						<span class="url">
							<?php echo dance_studio_return_content($website_link); ?>
						</span>
					<?php endif; ?>
		...
		<div class="cmsmasters_events_venue_header_right clearfix">
			<div class="tribe-events-back">
				<a class="cmsmasters_theme_icon_date" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'Back to %s', 'dance-studio' ), tribe_get_event_label_plural() ); ?></a>
			</div>
			<?php 
