...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Projects', 'dance-studio');

$filter_text = ($filter_text != '') ? $filter_text : __('Filter', 'dance-studio');

$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All', 'dance-studio');

$sorting_name_text = ($sorting_name_text != '') ? $sorting_name_text : esc_html__('Name', 'dance-studio');

$sorting_date_text = ($sorting_date_text != '') ? $sorting_date_text : esc_html__('Date', 'dance-studio');
