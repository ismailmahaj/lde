...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'dance-studio');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'dance-studio');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_attr__('All Categories', 'dance-studio');
