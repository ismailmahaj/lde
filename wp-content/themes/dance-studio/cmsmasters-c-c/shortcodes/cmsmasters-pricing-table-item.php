...
if ($best == 'true') {
	if ($best_bg_color != '') {
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_pricing_item_inner { ' . 
			"\n\t" . cmsmasters_color_css('background-color', $best_bg_color) . 
		"\n" . '} ' . "\n". 
		'#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_pricing_item_inner { ' . 
	...
	if ($best_text_color != '') {
		...
		'#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_pricing_item_inner:before { ' . 
			"\n\t" . cmsmasters_color_css('background-color', $best_text_color) . 
		"\n" . '} ' . "\n";
	}
}
