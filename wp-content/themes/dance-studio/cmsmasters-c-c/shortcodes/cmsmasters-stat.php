...
$out = '<div class="cmsmasters_stat_wrap' . (($this->stats_atts['stats_mode'] == 'bars' && $this->stats_atts['stats_type'] == 'vertical' || $this->stats_atts['stats_mode'] == 'circles') ? $this->stats_atts['stats_count'] : '') . '">' . "\n" . 
	...
	'</span>' . "\n" . 
				'<span class="cmsmasters_stat_title">' . $content . '</span>' . "\n" : '') . 
			'</div>' . "\n" . 
		'</div>' . "\n" . 
	...
	((($content != '' && $this->stats_atts['stats_mode'] == 'bars' && $this->stats_atts['stats_type'] == 'horizontal') || ($content != '' && $this->stats_atts['stats_mode'] == 'bars' && $this->stats_atts['stats_type'] == 'vertical')) ?
	'<span class="cmsmasters_stat_counter_wrap">' . "\n" . 
		'<span class="cmsmasters_stat_counter">' . (($this->stats_atts['stats_mode'] == 'bars') ? $progress : '0') . '</span>' . 
		'<span class="cmsmasters_stat_units">%</span>' . "\n" . 
	'</span>' . "\n" : '') .
