...
function dance_studio_admin_register($hook) {
	...
	wp_localize_script('cmsmasters-uploader-js', 'cmsmasters_admin_uploader', array( 
		'choose' => 				esc_attr__('Choose image', 'dance-studio'), 
		'insert' => 				esc_attr__('Insert image', 'dance-studio'), 
		'remove' => 				esc_attr__('Remove', 'dance-studio'), 
		'edit_gallery' => 			esc_attr__('Edit gallery', 'dance-studio') 
	));
	...
	wp_localize_script('cmsmasters-lightbox-js', 'cmsmasters_admin_lightbox', array( 
		'cancel' => 				esc_attr__('Cancel', 'dance-studio'), 
		'insert' => 				esc_attr__('Insert', 'dance-studio'), 
		'deselect' => 				esc_attr__('Deselect', 'dance-studio'), 
		'choose_icon' => 			esc_attr__('Choose Icon', 'dance-studio'), 
		'find_icons' => 			esc_attr__('Find icons', 'dance-studio'), 
		'min_length' => 			esc_attr__('min 2 symbols', 'dance-studio'), 
		'choose_font' => 			esc_attr__('Choose icons font', 'dance-studio'),
		'error_on_page' => 			esc_attr__("Error on page!\nReload page and try again.", 'dance-studio') 
	));
...
add_action('admin_enqueue_scripts', 'dance_studio_admin_register');
