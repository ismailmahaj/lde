...
function dance_studio_get_admin_page() {
	global $pagenow;
...
function dance_studio_default_tab() {
	$current_page = dance_studio_get_admin_page();
...
function dance_studio_get_the_tab() {
	global $pagenow;
	
	$default_tab = dance_studio_default_tab();
...
function dance_studio_settings_page_header() {
