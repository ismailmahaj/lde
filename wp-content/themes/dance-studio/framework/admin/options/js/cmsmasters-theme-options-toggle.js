...
(function ($) { 
  ...
  $('#cmsmasters_post_post_options').on('change', cmsmasters_post_post_options_change);
  ...
  $('#cmsmasters_project_project_options').on('change', cmsmasters_project_project_options_change);
