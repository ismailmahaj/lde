...
if ($cmsmasters_option['dance-studio' . '_sitemap_nav']) { 
	echo '<h2>' . esc_html__('Website Pages', 'dance-studio') . '</h2>';
...
if ($cmsmasters_option['dance-studio' . '_sitemap_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Blog Archives by Categories', 'dance-studio') . '</h2>' . 
...
if ($cmsmasters_option['dance-studio' . '_sitemap_tags']) {
	$tags = get_tags(array( 
		'orderby' => 'name', 
		'order' => 'DESC' 
	));
	...
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Blog Archives by Tags', 'dance-studio') . '</h2>' . 
...
if ($cmsmasters_option['dance-studio' . '_sitemap_month']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Blog Archives by Month', 'dance-studio') . '</h2>' . 
	'<ul class="cmsmasters_sitemap_archive">';
...
if ($cmsmasters_option['dance-studio' . '_sitemap_pj_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Portfolio Archives by Categories', 'dance-studio') . '</h2>' . 
	'<ul class="cmsmasters_sitemap_category">';
...
if ($cmsmasters_option['dance-studio' . '_sitemap_pj_tags']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Portfolio Archives by Tags', 'dance-studio') . '</h2>' . 
	'<ul class="cmsmasters_sitemap_archive">';
