...
<div id="page" class="<?php dance_studio_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header">
	<?php 
	dance_studio_header_top($cmsmasters_option);
	
	
	dance_studio_header_mid($cmsmasters_option);
	
	
	dance_studio_header_bot($cmsmasters_option);
	?>
</header>
...
list($cmsmasters_layout, $cmsmasters_page_scheme) = dance_studio_theme_page_layout_scheme();
